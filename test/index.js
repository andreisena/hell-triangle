...
describe('#triangle', () => {
    ...
    it('should calculate the maximum total', () => {
        let triangle = new Triangle([
            [6],
            [3, 5],
            [9, 7, 1],
        ...
        expect(triangle.maxTotal()).to.equal(26)
    })

    it('should calculate the maximum total of a larger triangle', () => {
        let triangle = new Triangle([
            [59],
            [73, 41],
            [52, 40, 9],
        ...
        expect(triangle.maxTotal()).to.equal(7273)
    })
})